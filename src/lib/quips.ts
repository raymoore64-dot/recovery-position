...
const ON_SHIFT_QUIPS = [
  ...
  "You've just spent 12 hours telling people to breathe. Well done. You've remembered the basics. Gold star.",
  "If the human body was a machine, the manufacturer would have recalled it in 1982.",
  "We're just meat bags full of angry soup, and you're paid to keep the soup from exploding. Heroic.",
  "The patient isn't 'difficult.' They're just a ghost in a bone suit who's had a really bad day.",
  "You don't need a cape. You need a working vending machine and a chair that doesn't wobble.",
  "Medicine is just advanced guessing with paperwork.",
  "Remember: we're all just temporary collections of stardust with a Wi-Fi signal.",
  "The paperwork is multiplying. I've seen it. It's breeding in the drawers.",
  "Management think 'empowerment' means giving you a biro that still has the lid on.",
  "If meetings burned calories, we'd all be supermodels.",
  "The only thing more dangerous than a sick patient is a manager with an Excel spreadsheet.",
  "They want 'efficiency'? Give everyone a catapult and send them home.",
  "I've seen more logic in a pigeon pecking a crisp packet than in our rota system.",
  "The audit isn't to help you. It's to prove the universe has a sense of irony.",
  "The patient is always right. Except when they're wrong. Which is always.",
  "WebMD says it's cancer. I say it's wind. Let's split the difference.",
  "They swallowed what? For a bet? Human beings are just toddlers with credit cards.",
  "You're not a doctor. You're a professional googler with a stethoscope and a poker face.",
  "Explaining medicine to a patient is like teaching a fish to ride a bicycle. But we try. We try.",
  "The patient is not an idiot. They are merely a tourist in your world.",
  "If they could fix themselves, they'd be at home. So smile. And hide the heavy things.",
  "Laughter is the only anaesthetic we're legally allowed to self-administer.",
  "If you don't laugh, you'll cry. And crying ruins your mascara and frightens the porters.",
  "Dark humour is like oxygen in here. You don't notice it, but you'd die without it.",
  "We're not cynical. We're just pre-emptively disappointed.",
  "The morgue is full of people who took themselves too seriously. Lighten up.",
  "Never trust a colleague who doesn't swear. They're bottling it up. Run.",
  "Don't panic. You're just a tiny ape on a wet rock, trying to stop other apes from falling apart.",
  "The answer to 'why is this happening?' is always 42. Or a virus. Same difference.",
  "Time is an illusion. Lunchtime doubly so. So just get to lunch.",
  "The universe is big. Really big. You won't believe how big. And you're worried about a bedsore?",
  "Mostly harmless. That's what they'd write on your file. Mostly.",
  "So long, and thanks for all the IV fluids.",
  "You are not a superhero. You're a human who occasionally remembers to eat.",
  "Your bladder is not a renewable energy source. Go. Pee. Now.",
  "Sleep is for the weak. And also for the strong. Basically, just sleep.",
  "Self-care isn't a scented candle. It's saying 'no' and walking away.",
  "You've seen worse. You've smelled worse. You've laughed at worse. You'll be fine.",
  "The only person you need to save is the one staring back in the mirror.",
  "You got a vein on the first try? You are a wizard. Own it.",
  "The patient ate a biscuit? That's a win. That's a massive win.",
  "You made someone laugh who thought they'd forgotten how. That's medicine.",
  "Nobody died. High five. That's the bar, and you cleared it.",
  "You found a pen that works. That's not luck. That's a sign from the gods.",
  "One hour without a call bell. That's a holiday in this place.",
  "The public think we're angels. Which is funny, because we've seen what they do with their own bodies.",
  "Clap for us? Clap for the person who can finally fix the boiler.",
  "Politicians talk about us like we're a bus service. We're not. We're chaos wranglers.",
  "The NHS isn't a religion. But we've got more faith than most vicars.",
  "They say we're heroes. Heroes don't have piles from cheap chairs.",
  "You are a miracle. A tired, caffeine-powered, slightly irritable miracle.",
  "If in doubt, make a cup of tea. If still in doubt, make two.",
  "You've survived every bad shift so far. That's a 100% track record.",
  "The human body is a nightmare. You are the nightmare's dreamcatcher.",
  "Don't just survive. Weirdly thrive. Like a cactus. In a bin.",
  "You're not losing your mind. You're just rearranging it for efficiency.",
  "Remember: dinosaurs had no healthcare workers. Look what happened to them.",
  "You are the bouncer at the club of life. Keep the riff-raff breathing.",
  "May your shifts be boring, your patients be sleepy, and your biscuits be chocolate.",
  "Right. Back to it. The world isn't going to save itself. Unfortunately.",
];
